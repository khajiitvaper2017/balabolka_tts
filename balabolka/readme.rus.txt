Балаболка (консольное приложение для использования онлайн-сервисов синтеза речи), версия 1.58
Copyright (с) 2019-2023 Илья Морозов
Все права защищены

WWW: http://www.cross-plus-a.com/ru/bweb.html
...
-s <имя_сервиса>
   Выбрать онлайн-сервис для синтеза речи ("google" или "g", "amazon" или "a", "baidu" или "b", "cerevoice" или "c", "ibm" или "i", "microsoft" или "m", "naver" или "n", "youdao" или "y"). По умолчанию значение равно "google".
...
-g <пол>
   ...
   Параметр поддерживают сервисы Amazon Polly, CereProc TTS, Google TTS, IBM Watson, Microsoft Azure, Naver TTS.
...
-n <имя_голоса>
   ...
   Параметр поддерживают сервисы Amazon Polly, CereProc TTS, Google Cloud TTS, IBM Watson, Microsoft Azure, Naver TTS.
...
-r <число>
   ...
   Для CereProc TTS значения находятся в диапазоне от "0.3" до "4.0".
   Для Google TTS и Microsoft Azure значения находятся в диапазоне от "0.1" до "3.0".
   Для Google Cloud TTS значения находятся в диапазоне от "0.25" до "4.0".
   Для IBM Watson значения находятся в диапазоне от "0.3" до "3.0".
...
--sub-fit или -sf
   ...
   Параметр поддерживают сервисы Amazon Polly, CereProc TTS, Google TTS, Microsoft Azure, Naver TTS.
...
bal4web -f "d:\Subtitles\movie.srt" -w "d:\Sound\movie.wav" -s Microsoft -l ru-RU -n Svetlana -r 1.1
...
Для сервиса Google Cloud TTS (если используется API-ключ) тег может содержать информацию о поле диктора ("f" или "m") или имени диктора. Скорость речи может принимать значения от "0.25" до "4.0"; нормальная скорость речи "1.0".

{{Lang=cmn-CN;f}}

{{Lang=cmn-CN;WaveNet-B;1.1}}

Для сервиса Naver TTS внутри тега можно указать имя голоса и скорость речи. Скорость речи может принимать значения от "0.5" до "1.5"; нормальная скорость речи "1.0".

{{Lang=en-US;Clara;0.8}}

Для сервиса Amazon Polly тег может содержать информацию о поле диктора ("f" или "m") или имени диктора. Скорость речи может принимать значения от "0.2" до "2.0"; нормальная скорость речи "1.0".

{{Lang=de-DE;f}}

{{Lang=de-DE;Dieter;1.4}}

Для сервиса IBM Watson можно указать имя голоса и скорость речи. Скорость речи может принимать значения от "0.3" до "2.0"; нормальная скорость речи "1.0".
...
Для сервиса CereProc TTS можно указать имя голоса и скорость речи. Скорость речи может принимать значения от "0.3" до "4.0"; нормальная скорость речи "1.0".

{{Lang=de-DE;Alex;1.5}}

Чтобы восстановить исходные настройки голоса, необходимо вставить этот тег:
